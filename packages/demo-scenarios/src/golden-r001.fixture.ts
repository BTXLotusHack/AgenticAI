...
export const GOLDEN_R001 = {
  ...
  trip: {
    ...
    leaderMemberId: "M001",
    origin: "Hoàn Kiếm, Hà Nội",
    destination: "Bãi Cháy, Hạ Long",
    plannedDeparture: "2026-07-20 07:30",
    expectedDurationMinutes: 150,
  },
  members: [
    { memberId: "M001", name: "Anh Minh", role: "leader" as const, locale: "vi" as const, vehicleLabel: "Car 1", vehicleType: "Car", privacySetting: "All members", voiceEnabled: true, batteryPercent: 92 },
    { memberId: "M002", name: "Chị Lan", role: "member" as const, locale: "vi" as const, vehicleLabel: "Car 2", vehicleType: "Car", privacySetting: "All members", voiceEnabled: true, batteryPercent: 88 },
    { memberId: "M003", name: "Anh Huy", role: "member" as const, locale: "vi" as const, vehicleLabel: "Car 3", vehicleType: "Car", privacySetting: "Leader only", voiceEnabled: true, batteryPercent: 81 },
    { memberId: "M004", name: "Chú Sơn", role: "member" as const, locale: "vi" as const, vehicleLabel: "Car 4", vehicleType: "Car", privacySetting: "All members", voiceEnabled: false, batteryPercent: 76 },
  ],
